        ...
        for ann in annotations:
            ...
            try:
                ...
                while filename256 in filename_set:
                    filename256 = filename256[:-4] + str(random.randint(0, 9)) + ".jpg"  # no overwrite
            ...
            if is_train:
                ...
                filename_list.append(filename256[:-4] + "_l.jpg")
                filename_list.append(filename256[:-4] + "_r.jpg")
                ...
                map_file.write("%s\t%d\n" % (filename256, label))
                cv2.imwrite(filename256, img256)
...
if __name__ == "__main__":
    coco256x256(dir_file, data_file, is_train=True)
